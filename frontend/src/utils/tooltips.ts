export const TOOLTIPS = {
  ...
  delta_filter: "Long Leg Delta (absolute value, 0.0–1.0): Filters by the directional exposure of the long option. Delta ≈ 0.50 is at-the-money. Delta < 0.40 is out-of-the-money (lower cost, higher risk). Delta > 0.60 is in-the-money (higher cost, higher probability). A range of 0.15–0.35 targets slightly OTM options. Put deltas are negative on the chain, but this filter uses the absolute value — enter 0.33 (or −0.33, both work) for puts and calls alike.",
